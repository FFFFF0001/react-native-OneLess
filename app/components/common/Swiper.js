...
/**
 * 页面设置视图位置跟随Tab的点击，初始想法是通过Route切换View。
 * 但是这样会造成一个问题就是切换View的时候就要刷新页面，会重新走一遍生命周期。
 * 造成页面的卡顿，体验很差。
 * 然后想到使用Android中的ViewPager+Fragment的想法。
...
export default class extends Component {
    ...
    setPage(e) {
        if (Platform.OS === 'android') {
            this.refs.scrollView.setPageWithoutAnimation(e);
        } else {
            this.setState({
                index: e
            })
